...
def _shutdown_threadpools(*groups):
    log.debug("Shutting down thread pools...", extra={"sock": "*"})
...
sys.registerCloser(lambda: _shutdown_threadpools(NIO_GROUP))
...
class _realsocket(object):
    ...
    def listen(self, backlog):
        ...
        sys.registerCloser(lambda: _shutdown_threadpools(self.parent_group, self.child_group))
